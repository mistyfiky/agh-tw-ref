...
\begin{document}
  ...
  \begin{thebibliography}{9}
    \bibitem{wazniak5} Programowanie współbieżne i rozproszone/PWR Wykład 5 - Studia Informatyczne http://wazniak.mimuw.edu.pl/index.php?title=Programowanie\_wsp\%C3\%B3\%C5\%82bie\%C5\%BCne\_i\_rozproszone/PWR\_Wyk\%C5\%82ad\_5\\
  \end{thebibliography}
